...
import store.intent.intentirc.IntentIRC;
import store.intent.intentirc.SessionProvider;
...
public class IRCConnection implements MinecraftUtil {
    ...
    public void startIRC() {
        if (Pulsive.INSTANCE.getIntentAccount() == null || Pulsive.INSTANCE.getIntentAccount().api_key == null) {
            System.out.println("No intent account available, skipping IRC connection");
            return;
        }
